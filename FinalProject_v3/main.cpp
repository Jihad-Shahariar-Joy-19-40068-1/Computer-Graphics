...
float walk = 0.0;//for human walking
float walk_back = 0.0;
...
{
    glPushMatrix();
    glTranslatef(10-84, 428-210, 0.0);
...
glColor3ub(176,31,2);
glVertex2i(0,0);                   //bridgep-bforward
glVertex2i(20,0);
glVertex2i(20,350);
glVertex2i(0,350);

glVertex2i(1280,0);               //bridgep-bforward
glVertex2i(1300,0);
glVertex2i(1300,350);
glVertex2i(1280,350);

glVertex2i(670,410);
glVertex2i(670,230);              //midp-1-carbehind
glVertex2i(685,230);
glVertex2i(685,410);

glVertex2i(580,360);
glVertex2i(580,100);             //midp-2-carforward
glVertex2i(595,100);
glVertex2i(595,360);

glVertex2i(580,360);
glVertex2i(670,410);             //midjoint-carforward
glVertex2i(685,410);
glVertex2i(595,360);
glEnd();
...
glVertex2i(20,100);//carforward
glVertex2i(580,360);
glVertex2i(670,410);//carbehind
glVertex2i(20,230);

//line
glBegin(GL_LINES);
glVertex2i(1280,230);//carbehind
glVertex2i(685,410);
glVertex2i(1280,100);//carforward
glVertex2i(595,360);
glEnd();

glBegin(GL_TRIANGLES);
glColor3ub(224, 11, 22);         //b-head-boatforward
glVertex2i(0,370);
glVertex2i(20,370);
glVertex2i(10,400);
...
void road_signboard_boat_forward()
{
glBegin(GL_QUADS);
glColor3ub(176,31,2);
glVertex2i(0,0);                   //bridgep-boatforward
glVertex2i(20,0);
glVertex2i(20,350);
glVertex2i(0,350);

glVertex2i(1280,0);               //bridgep-boatforward
glVertex2i(1300,0);
glVertex2i(1300,350);
glVertex2i(1280,350);
...
glBegin(GL_LINES);
glColor3ub(78, 153, 103);
glVertex2i(20,100);//boatforward
glVertex2i(580,360);
glVertex2i(1280,100);//boatforward
glVertex2i(595,360);
glEnd();
...
//glBegin(GL_QUADS);   //road covering part
